...
for xp in range(-1000001, 1000000, 200000):
    for yp in range(-1000000, 1000000, 200000):
        for zp in range(-1000000, 1000000, 200000):
            """
...
zp = -185512.5947212637
            ...
            #earth = sphere(pos=vec(0, 0, 0), radius=6371*o)
            sat = sphere(pos=vec(x, y, z), radius=0 * 3000*o)
            ...
            m = 8e22
            mu = 4 * pi * 1e-7
            dx = - (3 * m * x * z * mu) / (4 * pi * (x**2 + y**2 + z**2) ** 2.5)
            dy = - (3 * m * y * z * mu) / (4 * pi * (x**2 + y**2 + z**2) ** 2.5)
            dz = (m * (x**2 + y**2 - 2 * (z**2)) * mu) / (4 * pi * (x**2 + y**2 + z**2) ** 2.5)
